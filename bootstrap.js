...
Ext.Loader.addClassPathMappings({
  ...
  "Ext.cmd": "../../Users/Victor/bin/Sencha/Cmd/6.0.0.202/plugins/src",
...
Ext.ClassManager.addNameAlternateMappings({
  ...
  "Ext.ux.parse.data.ParseBatch": [],
  "Ext.ux.parse.data.ParseConnector": [],
  "Ext.ux.parse.data.proxy.Parse": [],
  "Ext.ux.parse.data.reader.Parse": [],
  "Ext.ux.parse.util.Array": [],
  "Ext.ux.parse.util.Date": [],
  "Ext.ux.parse.util.File": [],
  "Ext.ux.parse.util.Filter": [],
  "Ext.ux.parse.util.Relation": [],
...
Ext.ClassManager.addNameAliasMappings({
  ...
  "StratGo.view.MyDataItemMissions": [
    "widget.mydataitemmissions"
  ],
  "StratGo.view.MyDataItemStrategies": [
    "widget.mydataitemstrategies"
  ],
  "StratGo.view.MyDataViewMissions": [
    "widget.mydataviewmissions"
  ],
  "StratGo.view.MyDataViewStrategies": [
